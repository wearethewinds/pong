define(['Bar', 'Ball', 'Result', 'Player', 'keyprofiles/leftkeyboard', 'keyprofiles/rightkeyboard', 'PowerUpHandler', 'easeljs'], function (Bar, Ball, Result, Player, profile1, profile2, PowerUpHandler) {
    ...
    var start = function () {
        ...
        stage = new createjs.Stage('gameboardCanvas');
        stage.canvas.width = 1280;
        stage.canvas.height = 720;
        addBall.call(this);
        createPlayer.call(this, stage, 'left', profile1);
        createPlayer.call(this, stage, 'right', profile2);
    ...
    return {
        ...
        getHeight: getHeight,
        getPowerUp: function () { return powerups; },
        getStage: getStage,
        getWidth: getWidth,
